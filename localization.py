...
def ground_truth_top_view(myBox):
    ...
    # y_ratios = [1.95,2.10,2.16,2.19,2.22]
    # # ground_axis_lines values are calculated by calculate_ground_axis_lines function
    # ground_axis_lines = [0,188,251,304,359,416] 
    # map_axis_lines = [0,366.6,498.9,613.38,733.83,860.37]
    # y_ratios = [2, 2.16 ,2.28, 2.5, 2.67, 2.96]
    # ground_axis_lines = [0, 200, 416, 644, 844, 900]
    # map_axis_lines = [0, 100, 200, 310, 380, 400, 416]

    # ground_axis_lines = [0, 197.4, 346.5, 467.4, 575.8, 699.8, 804.3]
    ground_axis_lines = [0, 213.44, 366.53, 487.43, 595.78, 719.78, 824.3]

    map_axis_lines = [0, 104, 185, 247, 302, 364, 416]
    # y_ratios = [1.95,2.10,2.16,2.19,2.22]
    
    y_ratios = [1.87, 1.89,1.95 , 1.97, 2, 2.01]
    # y_ratios = [1.87, 1.90,1.96 , 1.98, 2.01, 2.02]
    # y_ratios = [1.5, 1.6,1.7 , 1.75, 1.85, 1.9]
    # y_ratios = [2.86, 2.89,2.95 , 2.97, 3, 3.01]
    # y_ratios = [1.95,2.10,2.16,2.19,2.22]   
    error = 10
